<#
	...
	DESC : This script will indefinitely suppress all alerting for node applications from a CSV supplied list within SolarWinds Orion
#>
param 
(
...
ForEach ($line in $myCSV) 
{
    ...
    ForEach-Object { Invoke-SwisVerb -SwisConnection $swConn "Orion.AlertSuppression" SuppressAlerts @($entityUris, [DateTime]::UtcNow ) | Out-Null }
}
